      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-8 py-16 lg:py-15">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative flex justify-center items-center min-h-[400px]">
            ...
            <div className="hidden md:block absolute right-10 top-14 animate-float bg-white rounded-2xl shadow-xl px-4 py-3 flex items-center gap-3 z-30">
            ...
            <div className="hidden md:block absolute right-7 bottom-10 animate-float bg-white rounded-2xl shadow-xl px-4 py-3 flex items-center gap-3 z-30">
