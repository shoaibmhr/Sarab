      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-8 py-16 lg:py-15">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="mt-2 text-gray-500 leading-8 max-w-lg mx-auto text-center lg:mx-0 lg:text-left">
          ...
          <div className="relative flex justify-center items-center min-h-[400px]">
            ...
            <div className="hidden md:block absolute left-0 top-20 animate-float bg-white rounded-2xl shadow-xl px-5 py-4 flex items-center gap-3 z-30">
