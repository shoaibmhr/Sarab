...
const CategoryModal = ({ isOpen, onClose, onSave, initialData }) => {
  // Lazy initializer — component mount hote hi ek dafa chalta hai,
  // initialData ke hisaab se seedha sahi state se shuru hota hai
        ...
        <form onSubmit={handleSubmit} className="space-y-4 px-5 py-5">
          <div>
            ...
            <input
              ...
              className={`
                w-full rounded-xl border bg-white px-4 py-2.5 text-sm text-slate-700
          ...
          <div>
            ...
            <textarea
              ...
              className={`
                w-full resize-none rounded-xl border bg-white px-4 py-2.5 text-sm text-slate-700
                outline-none transition-all duration-300
                focus:ring-2 focus:ring-orange-100
            ...
            <div className="flex items-center gap-4">
              ...
              <label
                className="
                  ...
                  border border-slate-200 px-4 py-2.5 text-sm font-semibold text-slate-600
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              type="submit"
              className="
                flex-1 rounded-xl bg-orange-600 py-2.5 text-sm font-semibold text-white
