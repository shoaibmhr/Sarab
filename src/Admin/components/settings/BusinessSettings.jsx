// src/admin/components/settings/BusinessSettings.jsx
import { useState } from "react";
import ToggleRow from "./ToggleRow";

const BusinessSettings = ({ data, onSave }) => {
  ...
  return (
    <div className="rounded-2xl border border-slate-100 bg-white p-4 shadow-sm sm:p-5">
      <h3 className="text-base font-bold text-slate-800">Business Rules</h3>
      <p className="text-sm text-slate-500">Orders aur pricing ke rules.</p>
      ...
      <div className="mt-4 space-y-3.5">
        ...
        <ToggleRow
          ...
          description="Naye orders automatically accept ho jayen"
